...
% Changes will need to be made to make this into a general-purpose function.
% See seg_linear_fit.m for a general-purpose function.
%
% Author: Shanqing Cai (shanqing.cai@gmail.com)
% Date: April 2007

function [knots_o, y_o, sse_o] = fitRLF_EF(picNum, unitPTC, varargin)
    toVisualize = 0
